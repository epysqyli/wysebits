...
import { getLoggedUser, getBookTile, getCategories } from "../../../../lib/serverSideMethods";
...
const EditBookTile = ({ bookData, entries, bookTileId, categories, userState }) => {
  if (userState.isLogged) {
    ...
    return (
      <div className='pt-10 lg:pt-16'>
        ...
        <div className='my-10 w-2/5 xl:w-1/5 mx-auto' onClick={() => deleteBookTile()}>
