...
export const getServerSideProps = async (context) => {
  try {
    ...
    if (context.query.searchTerms === undefined) {
      ...
      bookTiles = await searchWithinBookTiles(loggedUser.data.user.id, keywords, pageNum);
    }
...
const UserBookTiles = ({ bookTiles, pagy, userState, currentSearchTerms, searchParams }) => {
