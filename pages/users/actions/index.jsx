  ...
  if (userState.isLogged) {
    return (
      <>
        ...
        <div className="hidden md:block bg-user-welcome bg-cover bg-center lg:shadow-xl lg:w-4/5 2xl:w-2/3 lg:mt-5 lg:rounded-md mx-auto border-b-2 border-white">
