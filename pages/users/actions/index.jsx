    ...
    return (
      <div className='pt-10 lg:pt-16'>
        ...
        <div className='mx-auto w-4/5 lg:w-4/6 xl:w-5/6 2xl:w-3/4 py-4 md:py-16 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-y-2 md:gap-y-4 md:gap-x-2'>
          ...
          <div>
            <UserAction text='Statistics' href='/users/actions/stats' bcgImg='bg-stats' />
          </div>

          <div>
            <UserAction text='Conversations' href='/users/actions/conversations' bcgImg='bg-conversations' />
          </div>

          <div>
            <UserAction text='Manage profile' href='/users/actions/manage-profile' bcgImg='bg-settings' />
          </div>
        </div>
      </div>
    );
