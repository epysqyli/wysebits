...
const FavoriteInsights = ({ userState, favInsights, pagy, following, entriesUp, entriesDown }) => {
  const [followedUsers, setFollowedUsers] = useState(following);
  const [insights, setInsights] = useState(favInsights.filter((insight) => insight !== null));
