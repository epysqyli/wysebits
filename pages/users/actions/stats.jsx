          ...
          <div className='mx-auto my-20 grid grid-cols-1 lg:grid-cols-3 lg:gap-x-5 gap-y-10'>
            <div className='bg-gradient-to-br from-blue-50 to-blue-100 py-5 rounded text-gray-800 shadow hover:shadow-md transition-shadow border-2 border-white'>
              <div className='flex items-start justify-around border-b pb-4'>
                ...
                <div>
                  <div className='text-xl p-2 bg-gray-50 rounded-md shadow'>Best net entry</div>
                  <div className='my-2 text-center'>Total net votes: {entries.best_net_entry.net_votes}</div>
                </div>
              </div>
              ...
              <div className='text-center my-8'>
                ...
                >
                  <div className='my-2 cursor-pointer'>{entries.best_net_entry.book_tile.book.title}</div>
                </Link>
                <Link
                  href={`/authors/${slug(
                ...
                <Link href={`/categories/${entries.best_net_entry.book_tile.book.category.slug}?page=1`}>
                  <div className='my-2 text-sm italic cursor-pointer hover:text-black'>
            ...
            <div className='bg-gradient-to-br from-green-50 to-green-100 py-5 rounded text-gray-800 shadow hover:shadow-md transition-shadow border-2 border-white'>
              <div className='flex items-start justify-around border-b pb-4'>
                ...
                <div>
                  <div className='text-xl p-2 bg-gray-50 rounded-md shadow'>Most upvoted</div>
                  <div className='my-2 text-center'>Total upvotes: {entries.most_upvoted.upvotes}</div>
                </div>
              </div>
              ...
              <div className='text-center my-8'>
                ...
                <Link href={`/categories/${entries.most_upvoted.book_tile.book.category.slug}/1`}>
                  <div className='my-2 text-sm italic cursor-pointer hover:text-black'>
            ...
            <div className='bg-gradient-to-br from-red-50 to-red-100 py-5 rounded text-gray-800 shadow hover:shadow-md transition-shadow border-2 border-white'>
              <div className='flex items-start justify-around border-b pb-4'>
                ...
                <div>
                  <div className='text-xl p-2 bg-gray-50 rounded-md shadow'>Most downvoted</div>
                  <div className='my-2 text-center'>Total downvotes: {entries.most_downvoted.downvotes}</div>
                </div>
              </div>
              ...
              <div className='text-center my-8'>
                ...
                <Link href={`/categories/${entries.most_downvoted.book_tile.book.category.slug}/1`}>
                  <div className='my-2 text-sm italic cursor-pointer hover:text-black'>
