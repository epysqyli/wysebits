      ...
      <div className='pt-10 lg:pt-16'>
        ...
        <div className='mx-auto w-4/5 md:w-1/2 lg:w-2/5 xl:w-1/3 my-10'>
          <div className='mx-auto my-6'>
            <ManageBox text='Check your public page' href={`/creators/${userState.user.username}`} />
          </div>
          ...
          <div className='mx-auto my-6'>
            <ManageBox text='Update current password' href='/users/actions/manage-profile/update-password' />
          </div>

          <div className='mx-auto my-6'>
            <ManageBox text='Update current username' href='/users/actions/manage-profile/update-username' />
          </div>
