...
const Author = ({ books, pagy, authorName, urlSlug, currentSearchTerms, searchParams }) => {
    ...
    return (
      <div className='pt-10 lg:pt-12'>
        ...
        <div className='bg-author bg-cover bg-center shadow'>
          <div className='bg-gray-800 bg-opacity-70 text-white text-4xl text-center py-20'>{authorName}</div>
        </div>
  ...
  return (
    <div className='pt-10 lg:pt-16'>
      <IconAndTitle title={authorName} />
      <div className='bg-author bg-cover bg-center shadow'>
        <div className='bg-gray-800 bg-opacity-70 text-white text-4xl text-center py-16'>{authorName}</div>
      </div>
      ...
      <div className='mx-auto w-4/5 md:w-4/6 lg:w-3/6 xl:w-2/6 2xl:w-1/3 py-20 lg:py-40 2xl:py-48'>
        ...
        <div className='border px-5 mt-20 lg:mt-32 bg-gray-100 rounded-md shadow group transition-all cursor-pointer hover:shadow-md'>
          <div className='px-3 pt-5'>
            It might be that the author's books need to be assigned to him/her. You can do this while posting
            your insights for a specific book.
          </div>
          <div className='mt-10'>
            <MultiSearch
