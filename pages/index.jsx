    ...
    <div className="pb-10 bg-gradient-to-br from-gray-50 via-gray-100 to-blue-50">
      ...
      <div className="xl:flex xl:w-11/12 xl:mx-auto 2xl:w-5/6">
        <div className="mx-auto mb-20 xl:mb-10 w-11/12 md:w-4/6 lg:w-4/6 xl:w-2/5 px-4 xl:py-0 xl:border-b-2">
          <div className="text-gray-700 mb-10 md:mb-8 py-8 border-blue-400 border-t-4 border-l-4 rounded xl:rounded-tl-2xl bg-white">
            <div className="text-5xl mb-5 text-center">
              Search {capitalize(searchMode)}
            </div>
            <div
              className="flex justify-between w-4/6 md:w-3/5 lg:w-2/5 border-2 border-gray-200 mx-auto px-3 items-center text-gray-400 cursor-pointer bg-gray-50 hover:shadow xl:hover:shadow-none hover:px-5 active:shadow-inner active:bg-gray-200 transition-all rounded-md py-2"
        ...
        <div className="mb-10 w-11/12 mx-auto md:w-5/6 lg:w-4/6 xl:w-1/2 border-b-2 pb-10">
          <div className="flex justify-around items-center text-gray-700 gap-x-5 mb-10 md:mb-16 border-blue-400 border-r-4 border-b-4 shadow-md rounded bg-white py-8 xl:py-16 xl:rounded-br-2xl">
