    ...
    <div className="pt-12 lg:pt-16 2xl:pt-20">
      ...
      <div>
        <div className="md:flex justify-center items-center">
          ...
          <Link href="/feed">
            <div className="mx-auto md:mx-0 my-16 lg:my-20 w-11/12 md:w-3/5 lg:w-2/5 2xl:w-1/4 px-2 py-12 rounded-md bg-white hover:bg-gray-50 active:shadow-inner active:bg-blue-100 transition-colors cursor-pointer">
