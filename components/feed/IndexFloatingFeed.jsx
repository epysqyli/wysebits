...
const IndexFloatingFeed = () => {
  return (
    <div className='md:flex justify-center items-center relative insights-curve'>
      ...
      <Link href='/feed'>
        <div className='mx-auto md:mx-0 my-16 lg:my-20 w-11/12 md:w-3/5 lg:w-2/5 2xl:w-1/3 px-2 py-12 rounded-md bg-white hover:bg-slate-100 active:shadow-inner active:bg-slate-400 transition-colors cursor-pointer'>
          <div className='text-gray-600 mx-auto'>
            <Layers size={60} strokeWidth={1.5} className='mb-10 mx-auto' />
            <div className='text-center text-4xl font-medium'>Latest insights</div>
          </div>
        </div>
      </Link>
      <div className='hidden md:block relative h-80 w-20'>
