    ...
    <AnimatePresence>
      {currentBookId && (
        <motion.div
          ...
          className='z-30 w-full lg:w-5/6 xl:w-3/5 2xl:w-1/2 h-full lg:h-1/3 2xl:h-2/3 bg-white md:pt-20 md:pb-10 lg:py-5 px-2 lg:rounded-md lg:shadow overflow-auto'
        >
