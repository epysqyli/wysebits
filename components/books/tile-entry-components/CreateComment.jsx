...
const CreateComment = ({ entryId, userId, hideForm, updateCommentsState }) => {
  ...
  return (
    <div className='z-30 fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full lg:w-3/5 2xl:w-1/2 h-full lg:h-1/2 bg-white pt-20 pb-10 lg:py-5 px-2 lg:rounded lg:shadow overflow-auto lg:border-2 lg:border-gray-700'>
      ...
      <form onSubmit={handleSubmit} className='pt-2 px-2'>
        <label htmlFor='content' className='flex justify-around text-center py-2 bg-white rounded'>
        ...
        <div className='flex items-center justify-around lg:justify-center lg:gap-x-5 w-11/12 mx-auto mt-5'>
          <div
            onClick={hideForm}
            className='flex items-center justify-between gap-x-2 border p-2 rounded bg-gray-50 hover:bg-gray-100 cursor-pointer group'
          >
            <XCircle strokeWidth={1.5} className='text-gray-700 group-hover:scale-95 group-active:scale-90' />
            <div>discard comment</div>
          </div>
          <div className='flex items-center justify-between gap-x-2 border p-2 rounded bg-gray-50 hover:bg-gray-100 cursor-pointer group'>
            <PlusCircle
              strokeWidth={1.5}
