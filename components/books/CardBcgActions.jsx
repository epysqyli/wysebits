...
const CardBcgActions = ({ bookData, showEditForm, bcgImage }) => {
  return (
    <div className="relative py-6 md:py lg:w-4/5 2xl:w-2/3 lg:mt-5 lg:rounded-md mx-auto">
      <Image
        src={bcgImage()}
      ...
      <div className="w-4/5 md:w-4/6 lg:w-4/6 xl:w-3/5 2xl:w-1/2 mx-auto shadow-md backdrop-blur-md backdrop-brightness-75 text-white my-10 rounded-md relative z-10">
        <div className="mb-2">
