  ...
  return (
    <Link href={href}>
      <div className="cursor-pointer group relative group">
        ...
        >
          <div className="absolute z-10 left-1/2 top-1/2 md:top-1 -translate-x-1/2 -translate-y-1/2 md:translate-y-0 text-center text-xl md:py-1 text-white mb-1 w-4/5 mx-auto md:border-b-2 group-hover:bg-gray-50 group-hover:text-gray-800">
            {text}
          </div>
